# 🚌 BabyBus 宝宝巴适——公交全量线路图

> **版本：v1.0.0** · 基于 **Nuxt 4** · 高德地图 + SQLite

基于 **Nuxt 4** 的公交全量线路查询与地图可视化应用，用于可视化分析所在城市、所在地区公交线路覆盖，从而帮助租房，旅游等。
...
支持从高德地图拉取公交线路数据存入本地 SQLite，在交互式地图上多线路渲染、站点展示、正反向切换，以及线路数据的增删改查。

( 高德地图API貌似会卡梯子, 记得渲染地图的时候关科学上网 )
